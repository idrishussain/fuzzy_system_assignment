...
ac_fis = newfis('accalculator','mamdani','min','max','min','max','centroid');
...
rulelist = [ ...
1 1 5 3 2 1; 1 2 4 3 1.5 1; 1 3 4 2 1 1; 1 4 4 2 1 1; 1 5 4 1 1.8 1;...
2 1 4 3 1.2 1; 2 2 4 3 1 1; 2 3 4 2 1 1; 2 4 4 1 0.8 1; 2 5 4 1 1.2 1;...
3 1 3 3 1 1; 3 2 3 3 1 1; 3 3 3 2 1 1; 3 4 3 1 1 1; 3 5 3 1 1 1;...
4 1 2 3 1.2 1; 4 2 2 3 1 1; 4 3 2 2 1 1; 4 4 2 1 1 1; 4 5 2 1 1.8 1;...
5 1 1 3 2 1; 5 2 1 2 1 1; 5 3 1 1 0.8 1; 5 4 1 1 1.8 1; 5 5 1 1 2 1];
...
%Plot the 2D sufaces showing relationships between the input output pairs
subplot(4,1,1);
gensurf(ac_fis,[1],1)
subplot(4,1,2);
gensurf(ac_fis,[2],1)
...
%Plot the 3D surfaces showing the relationship between the two inputs and
%each of the outputs
subplot(2,1,1);
gensurf(ac_fis,[1 2],1)
subplot(2,1,2);
gensurf(ac_fis,[1 2],2)
